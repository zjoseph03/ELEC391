...
// #endif
  ...
  // Only be a central device - don't alternate roles
  Serial.println("\r\n * Device is a central - scanning for controller *\r\n\r\n");
  VR30Central central(ble, queue);
  central.run();
}
...
//         // FOLLOW UP: Transition BLE process to using mbedOS so that we can get access to the security manager as part of the BLE Stack
...
// - Our remote will be the peripheral, and our arduino will be the host (central)
// - Remote will be advertising
// - Arduino will be scanning
// */
...
// // TODO: Alter function so we're actually applying correct motor changes here
